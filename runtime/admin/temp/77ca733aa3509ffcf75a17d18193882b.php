<?php /*a:2:{s:60:"D:\phpstudy_pro\WWW\ymyz.cn\app\admin\view\kmuser\index.html";i:1644803314;s:59:"D:\phpstudy_pro\WWW\ymyz.cn\app\admin\view\common\base.html";i:1644930058;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
    <meta charset="utf-8">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form onsubmit="return false" action="#!" method="post" id="form1">
                    ...
                    <div class="form-group">
                      <label for="camilo" class="col-form-label">卡密</label>
                      <input type="text" class="form-control" id="camilo" name="camilo" placeholder="请输入卡密">
                    </div>
                    <div class="form-group" id="dqsj" style="display: none;">
...
<script type="text/javascript" src="/static/admin/js/tong/kmuser.js"></script>
