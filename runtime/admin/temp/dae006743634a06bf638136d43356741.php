<?php /*a:2:{s:67:"D:\phpstudy_pro\WWW\ymyz.cn\app\admin\view\classify_impl\index.html";i:1644803317;s:59:"D:\phpstudy_pro\WWW\ymyz.cn\app\admin\view\common\base.html";i:1644930058;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
    <meta charset="utf-8">
                ...
                <div class="modal-body">
                  <form onsubmit="return false" action="#!" method="post" id="form1">
                    ...
                    <div class="form-group">
                      <label for="title" class="col-form-label">分类名称</label>
                      <input type="text" class="form-control" id="title" name="title" placeholder="请输入分类名称">
                    </div>
                  </form>
                </div>
...
<script type="text/javascript" src="/static/admin/js/tong/classify.js"></script>
