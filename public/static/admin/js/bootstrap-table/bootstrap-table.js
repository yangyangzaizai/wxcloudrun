(function (global, factory) {
	...
	// toObject with fallback for non-array-like ES3 strings	var toIndexedObject = function (it) {
	...
	*/
	...
	var defineProperty$1 = objectDefineProperty.f;	var TO_STRING_TAG = wellKnownSymbol('toStringTag');
	...
	var $filter = arrayIteration.filter;	var HAS_SPECIES_SUPPORT = arrayMethodHasSpeciesSupport('filter');
	// Edge 14- issue
	...
	var $map = arrayIteration.map;	var HAS_SPECIES_SUPPORT$1 = arrayMethodHasSpeciesSupport('map');
	// FF49- issue
	...
	var charAt = stringMultibyte.charAt;	var STRING_ITERATOR = 'String Iterator';
